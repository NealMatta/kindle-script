...
import subprocess
from constant import user, email
...
ignored_extensions = ["pdf", ".DS_Store"]
# here all the downloaded files are kept
mypath = f"/Users/{user}/Downloads/ebooks/"

# path where converted files are stored
mypath_converted = f"/Users/{user}/Downloads/ebooks/kindle/"

# path where processed files will be moved to, clearing the downloaded folder
mypath_processed = f"/Users/{user}/Downloads/ebooks/processed/"
